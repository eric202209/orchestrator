...
from app.services.orchestration.execution.step_assessment import (
    _is_terminal_verification_only_failure,
    _persist_terminal_execution_failure,
    _same_declared_command,
)
...
from app.services.orchestration.phases.execution_debug_repair import (
    ...
    _command_fix_materially_targets_source_or_tests,
    _debug_prompt_mode_architecture,
                ...
                if local_inspection_result is not None:
                    ...
                    if local_verification_result is not None:
                        ...
                        if local_shell_result is not None:
                            ...
                            dispatch_outcome = dispatch_execution_runtime_step(
                                runtime_service=runtime_service,
                            ...
                            if runtime_service.reports_context_overflow(step_result):
                                ...
                                dispatch_outcome = dispatch_execution_runtime_step(
                                    runtime_service=runtime_service,
                                    prompt=compact_execution_prompt,
                                    timeout_seconds=step_timeout_seconds,
                                    db=db,
                                    task_execution_id=ctx.task_execution_id,
                                )
