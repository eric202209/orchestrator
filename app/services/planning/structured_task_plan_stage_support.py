"""Planning-owned provider and deterministic Task Plan support.

This module contains provider request construction, strict semantic parsing,
canonicalization, graph/coverage validation, and immutable planning values.
Workflow lifecycle remains in the orchestration adapter.
"""
...
from app.services.planning.stage_contract import StageContext
