"""Planning-owned provider and deterministic Brief-stage support.

This module contains provider request construction, strict semantic parsing,
canonicalization, validation support, and immutable planning values. Workflow
lifecycle remains in the orchestration adapter.
"""
