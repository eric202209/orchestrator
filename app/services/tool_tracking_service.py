...
class ToolTrackingService:
    ...
    def __init__(self, db: Session):
        self.db = db
        self.active_executions: Dict[str, ToolExecution] = {}  # execution_id -> ToolExecution
    ...
    def complete_execution(
        ...
        execution.execution_time_ms = (datetime.utcnow() - execution.timestamp).total_seconds() * 1000
    ...
    def _log_execution(self, level: str, message: str, metadata: Dict[str, Any]) -> None:
    ...
    def track(self, execution_id: str, tool_name: str, params: Dict[str, Any],
              result: Any, success: bool, session_id: int,
              task_id: Optional[int] = None, error_message: Optional[str] = None) -> ToolExecution:
        """
    ...
    def cleanup_old_executions(self, max_age_hours: int = 24) -> int:
        ...
        execution_ids = [
            exec_id for exec_id, exec_obj in self.active_executions.items()
