...
LABEL org.opencontainers.image.revision="${ORCHESTRATOR_GIT_SHA}" \
      org.opencontainers.image.created="${ORCHESTRATOR_BUILD_TIME}" \
      org.opencontainers.image.ref.name="${ORCHESTRATOR_IMAGE_TAG}"
